                    ...
                    events: {
                        show: function(opt) {
                            ...
                            $('#artwork-background-picker').change(function() {
                                ...
                                SVG.select('.artwork-background').members[0].fill(page.config.artwork.background);
                            });
                            ...
                            $('#border-color-picker').change(function() {
                                ...
                                SVG.select('.artwork-border').members[0].stroke(page.config.artwork.border);
                            });
...
var ImageEditor = (function() {
    ...
    */
    ...
    function ImageEditor(img, options) {
        $.snackbar('Image editor is not implemented yet.');
