                    ...
                    items: {
                            ...
                            callback: function() {
                                ...
                                new FileChooser(function(file) {
                                    ...
                                    file.load(function() {
                                        ...
                                        SVG.select('.page-image').load(this.result);
                                        $.overlay('hide');
                                    });
                                }, { format: 'image/*' }).open();
                            }
                        ...
                        remove: {
                            ...
                            callback: function() {
                                ...
                                SVG.select('.page-image').attr('href', null).orElse('dummy');
                            }
                        }
                    }
                }
                            ...
                            callback: function() {
                                ...
                                new FileChooser(function(file) {
                                    ...
                                    file.load(function() {
                                        ...
                                        SVG.select('.page-ribbon-bkg').load(this.result);
                                        $.overlay('hide');
                                    });
                                }, { format: 'image/*' }).open();
                            }
                    ...
                    items: {
                            ...
                            callback: function() {
                                new FileChooser(function(file) {
                                    ...
                                    file.load(function() {
                                        ...
                                        SVG.select('.cover-image').load(this.result);
                                        $.overlay('hide');
                                    });
                                }, { format: 'image/*' }).open();
                            }
                        ...
                        remove: {
                            ...
                            callback: function() {
                                ...
                                SVG.select('.cover-image').attr('href', null).orElse('dummy');
                            }
                        }
                    }
                }
