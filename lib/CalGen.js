					...
					events: {
						show: function(opt) {
							...
							$("#border-width-slider").slider({
								...
								change: function(event, ui) { page.config.artwork.border.width = ui.value }
							});
						},
						activated: function(opt) {
							...
							$('#artwork-background-picker').spectrum($.extend({}, {
								showAlpha: true,
								color: page.config.artwork.bkgColor || 'rgba(0, 0, 0, 0)',
								change: function(color) { page.config.artwork.bkgColor = color.toRgbString() }
							}, defaultSpectrum));

							$('#border-color-picker').spectrum($.extend({}, {
								showAlpha: true,
								color: page.config.artwork.border.color || 'rgba(0, 0, 0, 0)',
								change: function(color) { page.config.artwork.border.color = color.toRgbString() }
							}, defaultSpectrum));
						}
					},
					items: {
